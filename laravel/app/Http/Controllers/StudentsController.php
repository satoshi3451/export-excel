...
class StudentsController extends Controller
{
    ...
    public function export(){ //追加
        ...
        $arrays=[
            ...
            ['(目的物件の表示等)',"目的物件を特定するために必要な表示及び目的物件を売買すべき価額又は交換すべき評価額(以下「媒介価額」といいます。)は、一般媒介契約書の別表に記載します。",'4','0'],
        ...
        foreach($arrays as $array){
            if($array[3]==1){
                ...
                $worksheet->setCellValue(Coordinate::stringFromColumnIndex($dpoint_x+1).($dpoint_y+1), "第${Article_count}条");//タイトル
